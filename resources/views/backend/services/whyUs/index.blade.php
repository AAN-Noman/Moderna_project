    ...
    <div class="container">
        <div class="row">
            <div class="col-md-14">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>All why us <a href="{{ route('backend.whyUs.create') }}" class='btn btn-primary btn-sm'>Add
                            why us</a> </h2>
                                ...
                                @forelse ($datas as $data)
                                    <tr class="even pointer">
                                        ...
                                        <td class="last">
                                            ...
                                            <form class='d-inline'
                                                action="{{ route('backend.whyUs.destroy', $data->id) }}" method='POST'>
                                                @csrf
                                                @method('DELETE')
                            ...
                            <tbody>
                                @forelse ($DataTranshed as $data)
                                    <tr class="even pointer">
                                        ...
                                        <td>{{ $data->status == 1 ? 'Active' : 'Deactive' }}</td>
                                        <td class="last">
                                            <a href="{{ route('backend.whyUs.restore', $data->id) }}"
                                                class="btn btn-primary btn-sm">Restore</a>

                                            <button id="delete" value="{{ route('backend.whyUs.hardDelete', $data->id) }}" class="btn btn-danger btn-sm">Hard Delete</button>
                                    </tr>
                                @empty
                                @endforelse
                            </tbody>
