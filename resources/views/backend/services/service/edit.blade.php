        ...
        <div class="container">
            <div class='row'>
                <div class="col-md-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Service Edit <a href="{{ route('backend.service.index') }}" class="btn btn-primary btn-sm">All Service</a></h2>
                        ...
                        <div class="x_content">
                            ...
                            <form action="{{ route('backend.service.update', $service->id ) }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <textarea class="form-control" rows="3" placeholder="Description" name="description">{{$service->description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control" placeholder="Icon Color"
                                            name="iconColor" value="{{$service->iconColor}}">
                                    </div>
                                </div>
