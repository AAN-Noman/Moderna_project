...
@section('title', 'Tetstimonial Heading | ')
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="{{ route('backend.tetstimonial.store')}}" method="POST"
                                ...
                                @forelse ($datas as $data)
                                    <tr class="even pointer">
                                        ...
                                        <td class="last">
                                            ...
                                            <form class='d-inline'
                                                action="{{ route('backend.tetstimonial.destroy', $data->id) }}" method='POST'>
                                                @csrf
                                                @method('DELETE')
                                ...
                                @forelse ($DataTranshed as $data)
                                    <tr class="even pointer">
                                        ...
                                        <td class="last">
                                            ...
                                            <button id="delete" value="{{ route('backend.tetstimonial.hardDelete', $data->id) }}" class="btn btn-danger btn-sm">Hard Delete</button>
                                    </tr>
                                @empty
                                @endforelse
                            </tbody>
