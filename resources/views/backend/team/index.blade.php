                        ...
                        <form action="{{ route('backend.team.store')}}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" class="form-control" placeholder="Noman" name="name">
                                </div>
                                @error('name')
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" class="form-control" placeholder="link" name="twitter">
                                </div>
                                @error('twitter')
                                    <p class='text-danger'>{{ $message }}</p>
                                @enderror
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" class="form-control" placeholder="link" name="facebook">
                                </div>
                                @error('facebook')
                                    <p class='text-danger'>{{ $message }}</p>
                                @enderror
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" class="form-control" placeholder="link" name="instagram">
                                </div>
                                @error('instagram')
                                    <p class='text-danger'>{{ $message }}</p>
                                @enderror
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <input type="text" class="form-control" placeholder="link" name="linkedin">
                                </div>
                                @error('linkedin')
                                    <p class='text-danger'>{{ $message }}</p>
                                @enderror
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-3 col-sm-3 ">Image:<span class="required"></span>
                                </label>
                                <div class="col-md-9 col-sm-9 ">
                        ...
                        <table class="table table-striped jambo_table bulk_action">
                            <thead>
                                <tr class="headings">
                                    ...
                                    <th class='colume-title'>Profession</th>
                                    <th class='colume-title'>Description</th>
                                    <th class='colume-title'>Twitter</th>
                                    <th class='colume-title'>Facebook</th>
                                    <th class='colume-title'>Instagram</th>
                                    <th class='colume-title'>Linkedin</th>
                            ...
                            <tbody>
                                @forelse ($datas as $data)
                                    <tr class="even pointer">
                                        <td>{{ $data->id }}</td>
                                        <td>
                                            <img width="100" src="{{ asset('/storage/team/' . $data->photo) }}"
                                                alt="">
                                        </td>
                                        <td>{{ $data->name }}</td>
                                        ...
                                        <td>{{ Str::limit($data->linkedin, 10, '...') }}</td>
                                        <td>{{ $data->status == 1 ? 'Active' : 'Deactive' }}</td>
                                        <td class="last">
                                            <a href="{{ route('backend.team.edit', $data->id) }}"
                                                class="btn btn-primary btn-sm">View/Edit</a>
                                            <a href="{{ route('backend.team.status', $data->id) }}"
                                                class="btn btn-{{ $data->status == 1 ? 'warning' : 'success' }} btn-sm">
                                                {{ $data->status == 1 ? 'Deactive' : 'Active' }}
                                            </a>
                                            <form class='d-inline'
                                                action="{{ route('backend.team.destroy', $data->id) }}"
                                                method='POST'>
                                                @csrf
                                                @method('DELETE')
                            ...
                            <tbody>
                                @forelse ($DataTranshed as $data)
                                    <tr class="even pointer">
                                        ...
                                        <td>{{ $data->status == 1 ? 'Active' : 'Deactive' }}</td>
                                        <td class="last">
                                            <a href="{{ route('backend.team.restore', $data->id) }}"
                                                class="btn btn-primary btn-sm">Restore</a>

                                            <button id="delete"
                                                value="{{ route('backend.team.hardDelete', $data->id) }}"
                                                class="btn btn-danger btn-sm">Hard Delete</button>
                                    </tr>
                                @empty
                                @endforelse
                            </tbody>
