                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form action="{{ route('backend.banner.update', $banner->id ) }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="form-group row ">
                                    <label class="control-label col-md-3 col-sm-3 ">Button Link:</label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control" placeholder="Banner Link"
                                            name="button" value="{{$banner->button}}">
                                    </div>
                                </div>
                                <div class="form-group row">
